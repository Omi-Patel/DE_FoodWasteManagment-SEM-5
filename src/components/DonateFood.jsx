...
const DonateFood = () => {
  return (
    <div className="h-full">
      <div>
        <section className="text-blue-100 body-font">
          <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
            ...
            <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
              ...
              <p className="text-sm mt-2 text-gray-400  w-full">
      ...
      {/* // form */}
      <div
        data-fillout-id="iaySVEnyUhus"
        data-fillout-embed-type="popup"
        data-fillout-button-text="Fill Quality Form"
          ...
          <div className="container px-5 py-24 mx-auto">
            <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
              ...
              <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                <h2 className="text-blue-200 text-lg title-font font-medium mb-2">
                  Give and get items
                </h2>
